...
export function Header() {
    ...
    return (
        <header className="app-header sticky top-0 z-50 bg-[#07070a]/56 backdrop-blur-2xl">
...
export function Footer() {
    ...
    return (
        <footer className="border-t border-[color:var(--color-border)] mt-12 py-6 bg-black/10">
