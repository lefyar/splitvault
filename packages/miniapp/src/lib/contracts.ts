...
// Celo mainnet is the default launch network. Celo Sepolia remains available
// only when explicitly selected through env vars.
...
export const ACTIVE_CHAIN_ID = Number(import.meta.env.VITE_CELO_CHAIN_ID || CELO_CHAIN_ID)
...
export const CUSD_ADDRESS: Address =
  ...
  (ACTIVE_CHAIN_ID === CELO_CHAIN_ID
    ...
    : '0xBFa30e9f862776349b881875027990223bf122bD')
...
export const VAULT_FACTORY_ADDRESS: Address =
  ...
  (ACTIVE_CHAIN_ID === CELO_CHAIN_ID
    ? '0x82A9D7C665133377f307b2214B0195E55556898b'
    : '0x72Ea74291A0354E4385ed5Cb2a0ad3B33634F26a')
